...
public class UtilityActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] items={"Cultural Secretary","Sports Secretary","ge","gr","fr","gar"};
        ListAdapter Adapter = new CustomAdapterUtility(this, items,items1);
        ListView listview = (ListView) findViewById(R.id.utilityListView);
