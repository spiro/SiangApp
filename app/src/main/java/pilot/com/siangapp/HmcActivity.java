...
public class HmcActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] items={"Cultural Secretary","Sports Secretary","Maintenance Secretary","Welfare Secretary", "Mess Secretary","gdfg","ghgh"};
        ListAdapter Adapter = new CustomAdapter(this, items,items1);
        ListView listview = (ListView) findViewById(R.id.divyanshListView);
